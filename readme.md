...
- **XLM-RoBERTa** - Text feature extraction
- **VaderSentiments** - Sentiment Analysis
...
1. **Clone this repo**
```bash
git clone https://github.com/shad-datascience/SarcaSense.git
```
...
- GitHub: [@shad-datascience](https://github.com/shad-datascience)
